...
image bounds(0, 0, 696, 650) file("Mimic2.png") 
...
rslider bounds(608, 374, 61, 79) channel("volumeMod") range(0.01, 1, 0.2, 1, 0.001) text("Volume") colour(255, 201, 201, 255) fontcolour(219, 142, 142, 255) fontcolour:1(219, 142, 142, 255) outlinecolour(48, 1, 1, 255) textcolour(255, 183, 183, 255) trackercolour(255, 154, 154, 255) 
rslider bounds(608, 458, 61, 73) channel("pitchMod") range(0.01, 1, 0.2, 1, 0.001) text("Pitch") colour(255, 201, 201, 255) fontcolour(219, 142, 142, 255) fontcolour:1(219, 142, 142, 255) outlinecolour(48, 1, 1, 255) textcolour(255, 183, 183, 255) trackercolour(255, 154, 154, 255) 
...
numberbox bounds(54, 250, 53, 22) channel("startTimeBox") colour:0(11, 35, 48, 255) 
numberbox bounds(452, 250, 53, 22) channel("endTimeBox") colour:0(11, 35, 48, 255) 
